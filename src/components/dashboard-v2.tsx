...
export const DashboardV2 = ({ onNavigate }: DashboardV2Props) => {
  ...
  return (
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-slate-950/90 p-6 shadow-[0_32px_90px_-50px_rgba(59,130,246,0.45)]">
        <div className="pointer-events-none absolute inset-x-0 top-0 h-48 bg-[radial-gradient(circle_at_top,_rgba(79,70,229,0.32),_transparent_60%)]" />
        <div className="relative z-10 grid gap-6 lg:grid-cols-[1.9fr_1fr]">
          <div className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-[26px] border border-white/10 bg-gradient-to-br from-violet-600/10 to-slate-950/70 p-5 shadow-[0_24px_40px_-24px_rgba(99,102,241,0.6)]">
                <p className="text-xs uppercase tracking-[0.32em] text-violet-300 mb-2">Total assets</p>
                <p className="text-3xl font-semibold text-white">${totalBalance.toLocaleString('en-US', { maximumFractionDigits: 0 })}</p>
                <p className="text-xs text-slate-400 mt-3">Consolidated portfolio value across all connected wallets.</p>
              </div>
              <div className="rounded-[26px] border border-white/10 bg-gradient-to-br from-cyan-500/10 to-slate-950/70 p-5 shadow-[0_24px_40px_-24px_rgba(56,189,248,0.55)]">
              ...
              <div className="rounded-[26px] border border-white/10 bg-gradient-to-br from-emerald-500/10 to-slate-950/70 p-5 shadow-[0_24px_40px_-24px_rgba(16,185,129,0.55)]">
          ...
          <div className="rounded-[28px] border border-white/10 bg-slate-950/80 p-5 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.03)]">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="rounded-full bg-white/5 px-3 py-2 text-xs text-slate-300">Top tier</div>
            </div>
            <div className="mt-6 rounded-3xl bg-gradient-to-r from-cyan-500/20 to-slate-900/20 p-4">
            ...
            <div className="mt-6 grid gap-3">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="text-xl font-semibold text-white">+2.34%</p>
      ...
      <div className="grid gap-5 xl:grid-cols-[2.2fr_1fr]">
        <div className="space-y-5">
          <div className="rounded-[32px] border border-white/10 bg-slate-950/90 p-6 shadow-[0_30px_80px_-50px_rgba(56,189,248,0.35)]">
            ...
            {tokens.length > 0 ? (
              <div className="space-y-3">
                {(tokensExpanded ? tokens : tokens.slice(0, 4)).map((token) => (
                  <div key={`${token.address}:${token.name}`} className="grid grid-cols-[auto_1fr_auto] items-center gap-4 rounded-3xl border border-white/10 bg-white/5 p-4 transition hover:border-cyan-500/20 hover:bg-white/10">
          ...
          <div className="rounded-[32px] border border-white/10 bg-slate-950/90 p-6 shadow-[0_30px_80px_-50px_rgba(16,185,129,0.25)]">
        ...
        <div className="space-y-5">
          <div className="rounded-[32px] border border-white/10 bg-slate-950/90 p-6 shadow-[0_30px_80px_-50px_rgba(236,72,153,0.25)]">
            <div className="mb-5">
            ...
            <div className="grid gap-3">
              <button onClick={() => onNavigate?.('recovery')} className="rounded-3xl border border-cyan-500/10 bg-gradient-to-br from-cyan-500/10 to-slate-950/80 px-4 py-4 text-left text-white transition hover:border-cyan-400/30">
              ...
              <button onClick={() => onNavigate?.('security')} className="rounded-3xl border border-violet-500/10 bg-white/5 px-4 py-4 text-left text-white transition hover:border-violet-400/30">
              ...
              <button onClick={() => onNavigate?.('history')} className="rounded-3xl border border-emerald-500/10 bg-white/5 px-4 py-4 text-left text-white transition hover:border-emerald-400/30">
          ...
          <div className="rounded-[32px] border border-white/10 bg-gradient-to-br from-slate-900/90 to-slate-950/90 p-6 shadow-[0_30px_80px_-50px_rgba(148,163,184,0.15)]">
