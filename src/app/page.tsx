  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-900/20 to-slate-950">
      ...
      <div className="relative z-10">
        ...
        {/* Navigation */}
        <nav className="sticky top-16 z-30 border-b border-white/5 bg-slate-950/50 backdrop-blur-xl">
          ...
          {activeTab === 'swap' && (
            <div className="animate-in fade-in-50">
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm mt-1">Exchange your crypto instantly</p>
              </div>
              <TokenSwap />
            </div>
          )}
          ...
          {activeTab === 'send' && (
            <div className="animate-in fade-in-50">
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm mt-1">Transfer to any address</p>
              </div>
              <SendToken />
            </div>
          )}
